 ...
 * @returns {number}
 */
export function alphaLength(word) {
  if (!word) return 0;
 ...
 */
export function orpIndexForLength(length) {
 ...
 */
export function orpCharIndex(word) {
 ...
 * @returns {string}
 */
export function highlightOrpBracket(word) {
 ...
 * @returns {number}
 */
export function lengthMultiplier(len) {
  if (len < 8) return 1.0;
 ...
 */
export function pauseMultiplier(word, sentenceWordCount, isParagraphBreak) {
